...
theme.loadSyntax = function ()
	...
	local syntax = {
		...
		Statement =					{ fg = solarized.fg }, -- any statement
	...
	if vim.g.solarized_italic_variables == true then
		syntax.Identifier =				{fg = solarized.fg, bg = solarized.none, style = 'italic'}; -- any variable name
    else
		syntax.Identifier =				{fg = solarized.fg}; -- any variable name
    end
...
theme.loadEditor = function ()
	...
	local editor = {
        ...
        -- Dashboard
        DashboardShortCut =                     { fg = solarized.fg },
        DashboardHeader =                       { fg = solarized.fg },
        DashboardCenter =                       { fg = solarized.fg },
...
theme.loadTerminal = function ()
	...
	vim.g.terminal_color_8 = solarized.fg
...
theme.loadTreeSitter = function ()
    ...
    local treesitter = {
        ...
        TSField =                   { fg = solarized.fg}, -- For fields.
    ...
    if vim.g.solarized_italic_variables == true then
        treesitter.TSVariable =                { fg = solarized.fg, style = 'italic' } -- Any variable name that does not have another highlight.
        treesitter.TSVariableBuiltin =         { fg = solarized.fg, style = 'italic' } -- Variable names that are defined by the languages, like `this` or `self`.
    else
...
theme.loadPlugins = function()
    ...
    local plugins = {
        ...
        LspSagaSignatureHelpBorder =            { fg = solarized.fg },
